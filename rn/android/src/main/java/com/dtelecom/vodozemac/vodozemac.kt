...
package com.dtelecom.vodozemac
   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) = uniffiRustCall() { status ->
            ...
            UniffiLib.ffi_vodozemac_ffi_rustbuffer_alloc(size.toLong(), status)
        }.also {
            if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.ffi_vodozemac_ffi_rustbuffer_free(buf, status)
        }
    }
...
internal object IntegrityCheckingUniffiLib {
    init {
        Native.register(IntegrityCheckingUniffiLib::class.java, findLibraryName(componentName = "vodozemac"))
        uniffiCheckContractApiVersion(this)
        uniffiCheckApiChecksums(this)
    }
    external fun uniffi_vodozemac_ffi_checksum_method_account_create_inbound_session(
    ): Short
    external fun uniffi_vodozemac_ffi_checksum_method_account_create_outbound_session(
    ): Short
    external fun uniffi_vodozemac_ffi_checksum_method_account_fallback_key(
    ): Short
    external fun uniffi_vodozemac_ffi_checksum_method_account_generate_fallback_key(
    ): Short
    external fun uniffi_vodozemac_ffi_checksum_method_account_generate_one_time_keys(
    ): Short
    external fun uniffi_vodozemac_ffi_checksum_method_account_identity_keys(
    ): Short
    external fun uniffi_vodozemac_ffi_checksum_method_account_mark_keys_as_published(
    ): Short
    external fun uniffi_vodozemac_ffi_checksum_method_account_max_number_of_one_time_keys(
    ): Short
    external fun uniffi_vodozemac_ffi_checksum_method_account_one_time_keys(
    ): Short
    external fun uniffi_vodozemac_ffi_checksum_method_account_pickle(
    ): Short
    ...
    external fun uniffi_vodozemac_ffi_checksum_method_inboundresult_take_session(
    ): Short
    external fun uniffi_vodozemac_ffi_checksum_method_session_decrypt(
    ): Short
    external fun uniffi_vodozemac_ffi_checksum_method_session_encrypt(
    ): Short
    external fun uniffi_vodozemac_ffi_checksum_method_session_has_received_message(
    ): Short
    external fun uniffi_vodozemac_ffi_checksum_method_session_pickle(
    ): Short
    external fun uniffi_vodozemac_ffi_checksum_method_session_session_id(
    ): Short
    ...
    external fun ffi_vodozemac_ffi_uniffi_contract_version(
    ): Int
...
internal object UniffiLib {
    ...
    init {
        Native.register(UniffiLib::class.java, findLibraryName(componentName = "vodozemac"))
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_vodozemac_ffi_uniffi_contract_version()
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    if (lib.uniffi_vodozemac_ffi_checksum_method_account_create_inbound_session() != 62592.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_account_create_outbound_session() != 5057.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_account_fallback_key() != 50651.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_account_generate_fallback_key() != 29131.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_account_generate_one_time_keys() != 22697.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_account_identity_keys() != 42002.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_account_mark_keys_as_published() != 20297.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_account_max_number_of_one_time_keys() != 47922.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_account_one_time_keys() != 22577.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_account_pickle() != 12218.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_vodozemac_ffi_checksum_method_inboundresult_sender_identity_key() != 5115.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_inboundresult_take_session() != 14080.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_session_decrypt() != 64189.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_session_encrypt() != 4429.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_session_has_received_message() != 24651.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_session_pickle() != 2833.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_method_session_session_id() != 15375.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vodozemac_ffi_checksum_constructor_account_from_pickle() != 36910.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
public interface AccountInterface {
     ...
     */
    fun `createInboundSession`(`prekeyMessageBody`: kotlin.String): InboundResult
     ...
     */
    fun `createOutboundSession`(`theirIdentityKey`: kotlin.String, `theirOneTimeKey`: kotlin.String): Session
     ...
     */
    fun `fallbackKey`(): kotlin.String
    
    fun `generateFallbackKey`()
    
    fun `generateOneTimeKeys`(`count`: kotlin.UInt)
    
    /**
     * JSON string `{ "curve25519": "<base64>", "ed25519": "<base64>" }`.
     */
    fun `identityKeys`(): kotlin.String
    
    fun `markKeysAsPublished`()
    
    fun `maxNumberOfOneTimeKeys`(): kotlin.UInt
     ...
     */
    fun `sign`(`message`: kotlin.String): kotlin.String
...
open class Account: Disposable, AutoCloseable, AccountInterface
{
    ...
    UniffiLib.uniffi_vodozemac_ffi_fn_constructor_account_new(
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_vodozemac_ffi_fn_free_account(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall() { status ->
            UniffiLib.uniffi_vodozemac_ffi_fn_clone_account(handle, status)
        }
    }
     ...
     * decrypted plaintext of the initial message together.
     */
    @Throws(VodozemacException::class)override fun `createInboundSession`(`prekeyMessageBody`: kotlin.String): InboundResult {
            return FfiConverterTypeInboundResult.lift(
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_account_create_inbound_session(
        it,
        FfiConverterString.lower(`prekeyMessageBody`),_status)
}
    }
    )
    }
     ...
     * Both keys are base64.
     */
    @Throws(VodozemacException::class)override fun `createOutboundSession`(`theirIdentityKey`: kotlin.String, `theirOneTimeKey`: kotlin.String): Session {
            return FfiConverterTypeSession.lift(
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_account_create_outbound_session(
        it,
     ...
     * Empty inner map if no unpublished fallback exists.
     */
    @Throws(VodozemacException::class)override fun `fallbackKey`(): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_account_fallback_key(
        it,
        _status)
}
    }
    ...
    @Throws(VodozemacException::class)override fun `generateFallbackKey`()
        = 
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_account_generate_fallback_key(
        it,
        _status)
}
    }
    ...
    @Throws(VodozemacException::class)override fun `generateOneTimeKeys`(`count`: kotlin.UInt)
        = 
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_account_generate_one_time_keys(
        it,
     ...
     * JSON string `{ "curve25519": "<base64>", "ed25519": "<base64>" }`.
     */
    @Throws(VodozemacException::class)override fun `identityKeys`(): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_account_identity_keys(
        it,
        _status)
}
    }
    ...
    @Throws(VodozemacException::class)override fun `markKeysAsPublished`()
        = 
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_account_mark_keys_as_published(
        it,
        _status)
}
    }
    ...
    @Throws(VodozemacException::class)override fun `maxNumberOfOneTimeKeys`(): kotlin.UInt {
            return FfiConverterUInt.lift(
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_account_max_number_of_one_time_keys(
        it,
        _status)
}
    }
     ...
     * After `mark_keys_as_published`, the inner map is empty.
     */
    @Throws(VodozemacException::class)override fun `oneTimeKeys`(): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_account_one_time_keys(
        it,
        _status)
}
    }
    ...
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_account_pickle(
        it,
        _status)
}
    }
     ...
     * returning a base64 signature.
     */
    @Throws(VodozemacException::class)override fun `sign`(`message`: kotlin.String): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_account_sign(
        it,
     ...
     */
    @Throws(VodozemacException::class) fun `fromPickle`(`pickle`: kotlin.String): Account {
            return FfiConverterTypeAccount.lift(
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_constructor_account_from_pickle(
...
public interface InboundResultInterface {
     ...
     */
    fun `senderIdentityKey`(): kotlin.String
    
    /**
     * Take ownership of the new session. Errors if called twice.
     */
    fun `takeSession`(): Session
    
    companion object
}

open class InboundResult: Disposable, AutoCloseable, InboundResultInterface
{
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_vodozemac_ffi_fn_free_inboundresult(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall() { status ->
            UniffiLib.uniffi_vodozemac_ffi_fn_clone_inboundresult(handle, status)
        }
    }

    override fun `plaintext`(): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_inboundresult_plaintext(
        it,
        _status)
}
    }
     ...
     * The peer's curve25519 identity key, extracted from the prekey message.
     * Useful for on-prekey-message new-device discovery.
     */override fun `senderIdentityKey`(): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_inboundresult_sender_identity_key(
        it,
        _status)
}
    }
     ...
     * Take ownership of the new session. Errors if called twice.
     */
    @Throws(VodozemacException::class)override fun `takeSession`(): Session {
            return FfiConverterTypeSession.lift(
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_inboundresult_take_session(
        it,
        _status)
}
    }
 ...
 * @suppress
 */
public object FfiConverterTypeInboundResult: FfiConverter<InboundResult, Long> {
    override fun lower(value: InboundResult): Long {
        return value.uniffiCloneHandle()
    }

    override fun lift(value: Long): InboundResult {
        return InboundResult(UniffiWithHandle, value)
    }

    override fun read(buf: ByteBuffer): InboundResult {
        return lift(buf.getLong())
    }

    override fun allocationSize(value: InboundResult) = 8UL

    override fun write(value: InboundResult, buf: ByteBuffer) {
        buf.putLong(lower(value))
    }
}
...
public interface SessionInterface {
     ...
     */
    fun `decrypt`(`messageType`: kotlin.UByte, `body`: kotlin.String): kotlin.String
...
open class Session: Disposable, AutoCloseable, SessionInterface
{
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_vodozemac_ffi_fn_free_session(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall() { status ->
            UniffiLib.uniffi_vodozemac_ffi_fn_clone_session(handle, status)
        }
    }
     ...
     * Decrypt a message of the given type (0 = PreKey, 1 = Normal).
     */
    @Throws(VodozemacException::class)override fun `decrypt`(`messageType`: kotlin.UByte, `body`: kotlin.String): kotlin.String {
            return FfiConverterString.lift(
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_session_decrypt(
        it,
        FfiConverterUByte.lower(`messageType`),FfiConverterString.lower(`body`),_status)
}
    }
    )
    }
    ...
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_session_encrypt(
        it,
    ...
    @Throws(VodozemacException::class)override fun `hasReceivedMessage`(): kotlin.Boolean {
            return FfiConverterBoolean.lift(
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_session_has_received_message(
        it,
        _status)
}
    }
    ...
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_session_pickle(
        it,
        _status)
}
    }
    ...
    callWithHandle {
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_method_session_session_id(
        it,
        _status)
}
    }
     ...
     * Restore from a JSON pickle produced by `pickle()`.
     */
    @Throws(VodozemacException::class) fun `fromPickle`(`pickle`: kotlin.String): Session {
            return FfiConverterTypeSession.lift(
    uniffiRustCallWithError(VodozemacException) { _status ->
    UniffiLib.uniffi_vodozemac_ffi_fn_constructor_session_from_pickle(
...
public object FfiConverterTypeVodozemacError : FfiConverterRustBuffer<VodozemacException> {
    override fun read(buf: ByteBuffer): VodozemacException {
        ...
        return when(buf.getInt()) {
            1 -> VodozemacException.InvalidBase64(
                FfiConverterString.read(buf),
                )
            2 -> VodozemacException.DecryptException(
                FfiConverterString.read(buf),
                )
            3 -> VodozemacException.SessionException(
                FfiConverterString.read(buf),
                )
            4 -> VodozemacException.InvalidPickle(
                FfiConverterString.read(buf),
                )
            5 -> VodozemacException.InvalidUtf8(
                FfiConverterString.read(buf),
                )
            6 -> VodozemacException.InvalidMessageType(
                FfiConverterUByte.read(buf),
                )
            7 -> VodozemacException.SessionAlreadyTaken()
            8 -> VodozemacException.Internal(
                FfiConverterString.read(buf),
                )
    ...
    override fun allocationSize(value: VodozemacException): ULong {
        return when(value) {
            is VodozemacException.InvalidBase64 -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.`reason`)
            )
            is VodozemacException.DecryptException -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.`reason`)
            )
            is VodozemacException.SessionException -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.`reason`)
            )
            is VodozemacException.InvalidPickle -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.`reason`)
            )
            is VodozemacException.InvalidUtf8 -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.`reason`)
            )
            is VodozemacException.InvalidMessageType -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterUByte.allocationSize(value.`value`)
            )
            is VodozemacException.SessionAlreadyTaken -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is VodozemacException.Internal -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.`reason`)
            )
